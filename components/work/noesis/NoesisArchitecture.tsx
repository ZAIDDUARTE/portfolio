...
import { noesisArchitectureLayers } from "@/content/noesis";

export function NoesisArchitecture() {
  ...
  return (
    <section
      ...
      className="bg-[#1a2332] text-light"
    >
      <div className="section-pad mx-auto max-w-[1400px] py-16 md:py-24">
        ...
        >
          Five layers.
          <br />
          One spatial-temporal system.
        </h2>
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-light/70 md:text-lg">
          A public-safe conceptual architecture — specialized data layers
          feeding a modular inference pipeline, without exposing proprietary
          service names or internal formulas.
        </p>
      </div>
        ...
        <aside className="lg:col-span-5">
          <div className="sticky top-28">
            ...
            <ol className="mt-8 space-y-0" aria-hidden="true">
              {noesisArchitectureLayers.map((layer, index) => {
