...
import { atlasTechnicalDelivery } from "@/content/atlas";
    ...
    >
      <Reveal className="section-pad mx-auto max-w-[1400px]">
        ...
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-muted md:text-lg">
          Core capabilities implemented within documented scope — from governed
          evidence through validation workflows to release controls.
        </p>

        <ul className="mt-14 space-y-0 border-t border-border md:mt-16">
          {atlasTechnicalDelivery.map((row) => (
            <li
              key={row.capability}
