...
import { marginaiArchitectureLayers } from "@/content/marginai";

export function MarginAIArchitecture() {
  ...
  return (
    <section
      ...
      className="bg-[#12141a] text-light"
    >
      <div className="section-pad mx-auto max-w-[1400px] py-16 md:py-24">
        ...
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-light/70 md:text-lg">
          A public-safe architecture view — compatible ingress, optimization
          engine, provider forwarding, and modeled cost attribution.
        </p>
      </div>
        ...
        <aside className="lg:col-span-5">
          <div className="sticky top-28">
            ...
            <ol className="mt-8 space-y-0" aria-hidden="true">
              {marginaiArchitectureLayers.map((layer, index) => {
